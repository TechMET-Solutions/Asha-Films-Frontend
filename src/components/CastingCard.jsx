...
//          {applied ? (
//           <span className="text-green-600 w-[80%] mt-4 text-center border border-green-600 py-2 px-4 font-semibold">Applied</span>
//         ) : (
//           <button
//             onClick={()=>onApply()}
//             className="w-[80%] py-2 px-4 border border-primary text-gray-700 font-medium mt-4  cursor-pointer
    ...
    >
      ...
      {showActions && (
        <div className="mt-4 flex items-center justify-center px-4">
          {applied ? (
            <span className="text-green-600 w-[80%] mt-4 text-center border border-green-600 py-2 px-4 font-semibold">
            Applied
            </span>
          ) : (
            <button
