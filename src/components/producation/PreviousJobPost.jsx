...
//     navigate(`/production/applicant-profile/:userId`)
//   }
...
function PreviousJobPost() {
  ...
  return (
    <>
      <h1 className="text-[#8B3C68] font-bold text-xl mb-4">Previous Job Post</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6 hover:border-primary">
        {jobs.map((job) => (
          <CastingCard
            ...
            description={(job.project_description)?.slice(0, 60) + "..."}
            footer={
              <>
                <span className="text-red-600 font-medium text-sm">Closed</span>
                <button
