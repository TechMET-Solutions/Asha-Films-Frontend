...
import { ProductionHeader, ProductionProfileCard } from "../components";
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex flex-col md:flex-row gap-6 px-4 py-6 font-secondary flex-grow">
        ...
        {/* Sidebar */}
        <div
          className={`fixed md:static top-0 left-0 h-full w-84 bg-white shadow-md transform transition-transform duration-300 z-50 ${
