...
//       try {
//         const res = await axios.get(`${API}/api/content/projects`); // update if needed
//         if (res.data.success) {
...
//                   }}
//                   className="w-full mt-auto border border-primary text-primary py-2 px-4 text-sm font-medium hover:bg-purple-50 transition-colors"
//                 >
//                   SEE MORE
//                 </button>
//               </div>
...
import { useNavigate } from "react-router-dom";
import axios from "axios";
import CategorySelector from "../../components/ui/CategorySelector"; // your UI component
import { API } from "../../api";
