...
const UserVerification = () => {
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const response = await axios.post(`${API}/api/user/resend`, { email });
          ...
          {!isVerified ? (
            <>
              ...
              <p className="text-sm text-gray-600 text-center mb-6">
                Enter the 6-digit verification code sent <br />
                to {maskedEmail || 'your email'}
              </p>
              ...
              <p className="text-sm text-gray-500 mb-4">
                {countdown > 0 ? (
                  <>
                    Resend code in <span className="text-black">
