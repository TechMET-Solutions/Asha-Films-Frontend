...
function ProductionForgotPassword() {
    ...
    const handleSendOtp = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${API}/api/production/forgot-password`, {
                method: 'POST',
                headers: {
    ...
    const handleVerifyOtp = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${API}/api/production/verify`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    const handleResetPassword = async (e) => {
        ...
        try {
            setLoading(true);
            const response = await fetch(`${API}/api/production/reset-password`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
            ...
            setSuccess(true);
            setTimeout(() => navigate('/production/login'), 2000);
        } catch (err) {
...
export default ProductionForgotPassword;